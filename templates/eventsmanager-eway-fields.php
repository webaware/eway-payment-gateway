...
?>
	...
	<p class="em-bookings-form-gateway-cardno">
	  ...
	  <input type="text" size="15" name="x_card_num" value="<?php echo $card_num; ?>" class="input" />
	</p>
	...
	<p class="em-bookings-form-ccv">
	  <label>CVN</label>
	  <input type="text" size="4" name="x_card_code" value="<?php echo $card_code; ?>" class="input" />
	</p>
