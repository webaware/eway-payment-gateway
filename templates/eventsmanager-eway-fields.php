...
<p class="em-bookings-form-gateway-cardmessage"><?= $card_msg; ?></p>
<?php endif; ?>
...
<p class="em-bookings-form-gateway-cardno">
	...
	<input type="text" size="15" name="x_card_num" id="eway_card_num" value="<?= $card_num; ?>" class="input" pattern="[0-9]*"
...
<p class="em-bookings-form-gateway-cardname">
	...
	<input type="text" size="15" name="x_card_name" id="eway_card_name" value="<?= $card_name; ?>" class="input"
...
<p class="em-bookings-form-gateway-expiry">
	...
	<select name="x_exp_date_year" id="eway_exp_date_year" title="<?php esc_html_e('credit card expiry year', 'eway-payment-gateway'); ?>">
		<?= $optYears; ?>
	</select>
</p>

<p class="em-bookings-form-ccv">
	<label for="eway_card_code"><?= esc_html_e('CVN/CVV', 'eway-payment-gateway'); ?></label>
	<input type="text" size="4" name="x_card_code" id="eway_card_code" value="<?= $card_code; ?>" class="input" maxlength="4" pattern="[0-9]*"
		title="<?php esc_html_e('only digits 0-9 are accepted', 'eway-payment-gateway'); ?>" autocomplete="off" />
</p>
